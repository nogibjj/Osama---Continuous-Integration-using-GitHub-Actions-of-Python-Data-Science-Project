...
# and we will determine the probability of each part of an aircraft getting
#damaged by an aircraft wildlife strike
import io
import polars as pl
...
def AircraftAnalytics():
    """This is a function to run some
    analytics on aircraft wildlife accidents data"""   
    ...
    print(df.describe())
    print(df.mean())
    # # Now we are going to calculate the probability 
    # of each part of the flight getting damaged and plot these probabilities
    strikes = {}
    for c in df.columns:
        column_name = c.split(" ")
    ...
    #getting damaged and find the part with the highest damage probability
